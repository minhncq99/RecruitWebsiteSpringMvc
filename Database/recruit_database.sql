...
--
-- Table structure for table `applican`
--
...
CREATE TABLE `applican` (
  ...
  `experiance` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `career_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `applican_career_idx` (`career_id`),
  CONSTRAINT `applican_career` FOREIGN KEY (`career_id`) REFERENCES `career` (`id`),
  CONSTRAINT `applican_user` FOREIGN KEY (`id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `applican`
--

LOCK TABLES `applican` WRITE;
/*!40000 ALTER TABLE `applican` DISABLE KEYS */;
/*!40000 ALTER TABLE `applican` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `applican_news`
--

DROP TABLE IF EXISTS `applican_news`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `applican_news` (
  `applican_id` int NOT NULL,
  `news_id` int NOT NULL,
  `date` datetime NOT NULL,
  `state` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`applican_id`,`news_id`),
  KEY `applican_news_newsid_idx` (`news_id`),
  CONSTRAINT `applican_news_applicanid` FOREIGN KEY (`applican_id`) REFERENCES `applican` (`id`),
  CONSTRAINT `applican_news_newsid` FOREIGN KEY (`news_id`) REFERENCES `news` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `applican_news`
--

LOCK TABLES `applican_news` WRITE;
/*!40000 ALTER TABLE `applican_news` DISABLE KEYS */;
/*!40000 ALTER TABLE `applican_news` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `employer` (
  ...
  CONSTRAINT `employer_user` FOREIGN KEY (`id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `news` (
  ...
  `type_working` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `location_id` int NOT NULL,
...
-- Dump completed on 2021-04-13 14:44:39
