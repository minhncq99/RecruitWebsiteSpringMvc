...
var btnUser = document.querySelector("#register-block div:first-child p:first-child");
var btnManager = document.querySelector("#register-block div:first-child p:last-child");
